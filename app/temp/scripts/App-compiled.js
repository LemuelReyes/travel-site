...
var Adults = function (_Person) {
  _inherits(Adults, _Person);

  function Adults() {
    _classCallCheck(this, Adults);

    return _possibleConstructorReturn(this, (Adults.__proto__ || Object.getPrototypeOf(Adults)).apply(this, arguments));
  }
